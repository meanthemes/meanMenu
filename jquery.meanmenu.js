/*!
 * jQuery meanMenu v2.0.11 - Forked version (https://github.com/T-Fletcher/meanMenu)
 * 
...
(function($) {
  ...
  $.fn.meanmenu = function(options) {
    var defaults = {
      ...
      meanAria: true, // true to enable 'aria-expanded', 'aria-label' and 'role' attributes on expand links, false to leave them out
            ...
            if (meanExpandableChildren) {
              jQuery('.mean-nav ul ul').each(function() {
                if (jQuery(this).children().length) {
                  ...
                  if (meanAria == true) {
                    var expandLinkLabel = jQuery(this, 'li:first > ul').prev('a').text(),
                      expandLink = '<a class="mean-expand" aria-expanded="false" aria-label="' + expandLinkLabel + ' menu" role="button" href="#" style="font-size: ' + meanMenuCloseSize + '">' + meanExpand + '</a>';
                  } else {
